...
INSERT INTO `spengerspital`.`at_attachment` (`id`, `at_contenttype`, `at_creation`, `at_data`, `at_hash`, `at_language`, `at_size`, `at_title`, `at_url`, `at_patient_fk`) VALUES ('id001', 'contentHALLO', '2019-12-17', 'MkNBNDE3NTJDQ0Y0REJEQjc2RDhGRTg4QzQ4OEZENDQ=', 'hashWOOHOOOO', 'german', '34', 'TITEL:)', 'https://dreck.com', 'xyz987');
